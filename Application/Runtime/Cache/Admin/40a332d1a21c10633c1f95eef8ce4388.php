...
<div class="main-div">
    ...
    <form action="/Admin/Rule/add" method="post" name="theForm" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td>
                    <select name="parent_id">
                        ...
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" ><?php echo (str_repeat('&nbsp;',$vo["lev"])); echo ($vo["rule_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
        </table>
