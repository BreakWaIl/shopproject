...
<head>
	...
	<title>京西商城</title>
	<link rel="stylesheet" href="/Public/Home/style/base.css?version=<?php echo (C("VERISION")); ?>" type="text/css">
	<link rel="stylesheet" href="/Public/Home/style/global.css?version=<?php echo (C("VERISION")); ?>" type="text/css">
	<link rel="stylesheet" href="/Public/Home/style/header.css?version=<?php echo (C("VERISION")); ?>" type="text/css">
	<link rel="stylesheet" href="/Public/Home/style/index.css?version=<?php echo (C("VERISION")); ?>" type="text/css">
	<link rel="stylesheet" href="/Public/Home/style/bottomnav.css?version=<?php echo (C("VERISION")); ?>" type="text/css">
	<link rel="stylesheet" href="/Public/Home/style/footer.css?version=<?php echo (C("VERISION")); ?>" type="text/css">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="hot none">
					<ul>
						<?php if(is_array($hots)): $i = 0; $__LIST__ = $hots;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><img src="<?php echo (C("DOMAIN")); echo ($vo["goods_thumb"]); ?>" alt="" /></a></dt>
				...
				<div class="recommend none">
					<ul>
						<?php if(is_array($recs)): $i = 0; $__LIST__ = $recs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><img src="<?php echo (C("DOMAIN")); echo ($vo["goods_thumb"]); ?>" alt="" /></a></dt>
								<dd><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><?php echo ($vo["goods_name"]); ?></a></dd>
								<dd><span>售价：</span><strong> ￥<?php echo ($vo["shop_price"]); ?></strong></dd>
