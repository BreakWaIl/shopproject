...
<div class="topnav">
	<div class="topnav_bd w1210 bc">
		...
		<div class="topnav_right fr">
			<ul>
				<?php if(empty($user)): ?><li>您好，欢迎来到京西！[<a href="login.html">登录</a>] [<a href="register.html">免费注册</a>] </li>
				<?php else: ?>
				<li>您好<strong><?php echo ($user["username"]); ?></strong>欢迎来到京西！</li><?php endif; ?>
				<li class="line">|</li>
				<li>我的订单</li>
				<li class="line">|</li>
				<li>客户服务</li>
	...
	<div class="nav w1210 bc mt10">
		...
		<div class="category fl <?php if(empty($is_show)): ?>cat1<?php endif; ?>"> <!-- 非首页，需要添加cat1类 -->
			...
			<div class="cat_bd <?php if(empty($is_show)): ?>none<?php endif; ?>">
				<?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["parent_id"]) == "0"): ?><div class="cat item1">
					<h3><a href="<?php echo U('Category/index','id='.$vo['id']);?>"><?php echo ($vo["cname"]); ?></a> <b></b></h3>
					<div class="cat_detail">
						<?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if(($v["parent_id"]) == $vo["id"]): ?><dl class="dl_1st">
							<dt><a href="<?php echo U('Category/index','id='.$v['id']);?>"><?php echo ($v["cname"]); ?></a></dt>
							<dd>
							<?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i; if(($v2["parent_id"]) == $v["id"]): ?><a href="<?php echo U('Category/index','id='.$v2['id']);?>"><?php echo ($v2["cname"]); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
							</dd>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="/<?php echo ($img["0"]["goods_img"]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/<?php echo ($img["0"]["goods_img"]); ?>" alt="" width="350" height="350" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($img)): $i = 0; $__LIST__ = $img;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if(($i) == "1"): ?>class="cur"<?php endif; ?>>
									<a <?php if(($i) == "1"): ?>class="zoomThumbActive"<?php endif; ?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/<?php echo ($vo["goods_img"]); ?>',largeimage: '/<?php echo ($vo["goods_img"]); ?>'}"><img src="/<?php echo ($vo["goods_thumb"]); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?php echo (date('Y-m-d H:i:s',$goods_info["addtime"])); ?></li>
						...
						<ul>
							<?php if(is_array($sigle)): $i = 0; $__LIST__ = $sigle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="product">
								<dl>
									...
									<dd>
										<?php if(is_array($vo)): $index = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($index % 2 );++$index;?><a <?php if(($index) == "1"): ?>class="selected"<?php endif; ?> href="javascript:;"><?php echo ($v["attr_value"]); ?> <input type="radio" name="attr[<?php echo ($v["attr_id"]); ?>]" value="<?php echo ($v["id"]); ?>"  <?php if(($index) == "1"): ?>checked="checked"<?php endif; ?> /></a><?php endforeach; endif; else: echo "" ;endif; ?>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php if(is_array($unique)): $i = 0; $__LIST__ = $unique;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span><?php echo ($vo["attr_name"]); ?>：</span><?php echo ($vo["attr_value"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>

						<div class="desc mt10">
							<?php echo ($goods_info["goods_body"]); ?>
						</div>
					</div>
					<!-- 商品介绍 end -->
